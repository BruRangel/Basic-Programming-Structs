...
int main(){
    int tamanho_vetor_a = 0, vetor_a[20], temp = 1;

    for(tamanho_vetor_a; tamanho_vetor_a < 20; tamanho_vetor_a++){
        printf("Digite o valor do %d elemento do vetor: ", tamanho_vetor_a+1);
        scanf("%d", &temp);
        if(temp < 0){
            break;
        }
        vetor_a[tamanho_vetor_a] = temp;
    }
