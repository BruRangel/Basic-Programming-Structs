...
void ordenaCrescenteVetor(int vetor[], int tamanho) {
...
void main() {
    ...
    printf("Digite quantos numeros serao inicialmente inseridos no vetor (ate 30): ");
    scanf("%d", &tamanho);
    ...
    ordenaCrescenteVetor(vetor, tamanho);

    tamanho++;

    for (tamanho; tamanho <= 30; tamanho++){
        printf("Digite um novo elemento para o vetor: ");
